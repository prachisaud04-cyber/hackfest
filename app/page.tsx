...
export default function Page() {
  ...
  return <main>
    ...
    <footer><div className="footer-top"><div><a href="#home" className="logo">HACKFEST <small>2026</small></a><p>2 Days. One Idea. Endless Possibilities.</p></div><div className="footer-links">{['Home', 'About', 'Tracks', 'Schedule', 'Prizes', 'FAQ', 'Contact'].map(link => <a key={link} href={`#${link.toLowerCase()}`}>{link}</a>)}</div><div className="socials"><a href="#contact" aria-label="GitHub"><GitBranch size={18} /></a><a href="#contact" aria-label="LinkedIn"><BriefcaseBusiness size={18} /></a><a href="#contact" aria-label="Instagram"><Sparkles size={18} /></a><a href="#contact" aria-label="X"><X size={18} /></a></div></div><div className="footer-bottom"><span>© 2026 HackFest. Demo project created for educational purposes.</span><span>GUWAHATI · INDIA</span></div></footer>
  </main>
}
